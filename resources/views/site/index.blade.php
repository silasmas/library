            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="page-scroll" href="#pricing">Tarif</a></li>
...
<section  class="container features">
    ...
    <div class="row">
        <div class="text-center col-md-3 wow fadeInLeft">
            <div>
        ...
        <div class="text-center col-md-6 wow zoomIn">
            <img src="{{ asset('assets/img/landing/perspective.png') }}" alt="dashboard" class="img-responsive">
        </div>
        <div class="text-center col-md-3 wow fadeInRight">
            <div>
    ...
    <div class="row features-block">
        ...
        <div class="text-right col-lg-6 wow fadeInRight">
            <img src="{{ asset('assets/img/landing/dashboard.png') }}" alt="dashboard" class="img-responsive pull-right">
        </div>
    </div>
</section>
...
<section id="team" class="gray-section team">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-4 wow fadeInLeft">
                <div class="team-member">
                    <img src="{{ asset('assets/img/landing/avatar3.jpg') }}" class="img-responsive img-circle img-small" alt="">
            ...
            <div class="col-sm-4">
                <div class="team-member wow zoomIn">
                    <img src="{{ asset('assets/img/landing/avatar1.jpg') }}" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-4 wow fadeInRight">
                <div class="team-member">
                    <img src="{{ asset('assets/img/landing/avatar2.jpg') }}" class="img-responsive img-circle img-small" alt="">
        ...
        <div class="row">
            <div class="text-center col-lg-8 col-lg-offset-2 m-t-lg m-b-lg">
...
<section class="features">
    <div class="container">
        ...
        <div class="row features-block">
            ...
            <div class="text-right col-lg-6 m-t-n-lg wow zoomIn">
                <img src="{{ asset('assets/img/landing/iphone.jpg') }}" class="img-responsive" alt="dashboard">
            </div>
            <div class="text-right col-lg-3 features-text wow fadeInRight">
                <small>INSPINIA</small>
                <h2>Perfectly designed </h2>
                <p>INSPINIA Admin Theme is a premium admin dashboard template with flat design concept. It is fully responsive admin dashboard template built with Bootstrap 3+ Framework, HTML5 and CSS3, Media query. It has a huge collection of reusable UI components and integrated with latest jQuery plugins.</p>
                <a href="" class="btn btn-primary">Learn more</a>
...
<section id="testimonials" class="navy-section testimonials" style="margin-top: 0">
    ...
    <div class="container">
        <div class="row">
            <div class="text-center col-lg-12 wow zoomIn">
...
<section id="pricing" class="pricing">
    <div class="container">
        ...
        <div class="row m-t-lg">
            <div class="text-center col-lg-8 col-lg-offset-2 m-t-lg">
